...
public class PopErrorExtract {
	public static void main(String[] args) throws Exception {
		...
		String input="/home/vishal/Desktop/testPopulationInfoError.txt";
		String op="/home/vishal/Desktop/testPopulationInfoError";
		Job job = new Job();
		job.setJarByClass(PopErrorExtract.class);
...
public class SSJobConf extends JobConf {
	...
	public void initialize() {
		...
		JobConf.setMapperClassName("populationErrorRecords.SSMapper");
		JobConf.setReducerClassName("populationErrorRecords.SSReducer");
	}
}
